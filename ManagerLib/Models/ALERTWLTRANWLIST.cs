...
namespace ManagerLib.Models
{
    ...
    [Table("ALERTWLTRANWLIST")]
    public class _ALERTWLTRANWLIST
    {

        public _ALERTWLTRANWLIST() { }

        public _ALERTWLTRANWLIST(bool setDefaultValue)
        {
            COMP_CODE = 0;
            ALERT_ID = 0;
            SEQ_NO = 0;
