...
{
    public class ALERTTRANWLISTDTL
    {
    ...
    [Table("ALERTTRANWLISTDTL")]
    public class _ALERTTRANWLISTDTL
    {

        public _ALERTTRANWLISTDTL() { }

        public _ALERTTRANWLISTDTL(bool setDefaultValue)
        {
            COMP_CODE = 0;
            ALERT_ID = 0;
            ENTITY_ID = "";
