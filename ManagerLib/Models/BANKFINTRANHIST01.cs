...
{
    public class BANKFINTRANHIST01
    {
    ...
    [Table("BANKFINTRANHIST01")]
    public class _BANKFINTRANHIST01
    {

        public _BANKFINTRANHIST01() { }

        public _BANKFINTRANHIST01(bool setDefaultValue)
        {
            SEQ_NO = 0;
            TRAN_ID = 0;
            COMP_CODE = 0;
