...
namespace AgentRiskScore.Models
{
    ...
    public partial class ParamUser
    {
        ...
        /// </summary>
        public int? PwDefaultVal { get; set; }
        /// <summary>
        /// List of restricted password in the system
        /// </summary>
        public string PwRestricted { get; set; }
        public int? PwAgeHist { get; set; }
        /// <summary>
        /// 0-Disable / 1-Enable
        /// </summary>
        public int? PwAgeLock { get; set; }
        /// <summary>
        /// 0-Disable / 1-Enable
        /// </summary>
        public int? PwExpiryMail { get; set; }
        /// <summary>
        /// Force change PW after reset
        /// </summary>
        public int? PwResetForce { get; set; }
        /// <summary>
        /// 0-Disable / 1-Enable
        /// </summary>
        public int? PwPolicy { get; set; }
        /// <summary>
