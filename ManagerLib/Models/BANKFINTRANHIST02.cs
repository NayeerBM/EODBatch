...
{
    public class BANKFINTRANHIST02
    {
    ...
    [Table("BANKFINTRANHIST02")]
    public class _BANKFINTRANHIST02
    {

        public _BANKFINTRANHIST02() { }

        public _BANKFINTRANHIST02(bool setDefaultValue)
        {
            SEQ_NO = 0;
            TRAN_ID = 0;
            COMP_CODE = 0;
